			...
			<div class="modal-body">
				...
				<form id="loginform" class="loginform" action="../../memberClLoginAction.me?<%=request.getQueryString()%>" method='post'>
					...
					<div style="margin-bottom: 12px" class="input-group">
						...
						<input id="mid" type="text" class="form-control" name="mid" value="" placeholder="아이디" data-toggle="tooltip" data-placement="top" title="아이디 입력란" required>
					</div>
					<label>비밀번호</label> 
					<div style="margin-bottom: 12px" class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
						<input id="mpw" type="password" class="form-control" name="mpw" placeholder="비밀번호" data-toggle="tooltip" data-placement="top" title="비밀번호 입력란" required>
					</div>
