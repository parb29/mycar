...
<jsp:include page="../main/mycarClHeader.jsp"></jsp:include>
	...
	<section id="notice">
		<table class="table table-striped table-hover">
			...
			<tr id="title"
				...
				<td class="text-center hidden-xs visible-lg visible-md"><%=articleList.get(i).getNNUM()%></td>
				...
				<td class="text-center hidden-xs visible-lg visible-md"><%=articleList.get(i).getNREAD()%></td>
				<td class="text-center hidden-xs visible-lg visible-md"><%=articleList.get(i).getNDATE()%></td>
			</tr>
			<%
				}
			%>
  ...
  <ul class="pagination pagination-sm">
		...
		<%}else{ %>
	<li class="page-item">
      <a class="page-link" href="noticeClList.no?page=<%=startPage-1 %>" title="<%=startPage-1 %> 페이지로 이동">이전
      </a>
    </li>
		<%} %>
		...
		<%}else{ %>
	<li class="page-item">
		<a class="page-link" href="noticeClList.no?page=<%=endPage+1 %>" title="<%=endPage+1 %> 페이지로 이동">다음
		</a>
		    </li>
  </ul>
</nav>
