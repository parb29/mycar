...
<body>
	...
	<section id="articleForm">
		<%
			if (reply == null) {
		%>
		<button type="button" class="btn btn-default btn-sm" onclick="location.href='qnaQAdUpdate.qn?QNUM=<%=article.getQNUM()%>&page=<%=nowPage%>'" title="수정">게시글 수정</button>
		...
		<div class="modal fade" id="delete" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="text-align:center;">정말로 삭제 하시겠습니까?</div>
