...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://localhost:8080/mycar/resAdSearchAction.re"><strong>MyCar</strong>
      </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="http://localhost:8080/mycar/resAdSearchAction.re">&nbsp;&nbsp;&nbsp;예약목록&nbsp;&nbsp;&nbsp;</a></li>
        <li><a href="memberAdListAction.me">&nbsp;&nbsp;&nbsp;회원목록&nbsp;&nbsp;&nbsp;</a></li>
        <li><a href="http://localhost:8080/mycar/carAdSearchList.ca?page=1&&fieldName=All&&word=">&nbsp;&nbsp;&nbsp;상품목록&nbsp;&nbsp;&nbsp;</a></li>
