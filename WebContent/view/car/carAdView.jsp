  ...
  <div class="row">
    ...
    <div class="well"  style="background-color: #FFFFFF;">
     <form class="form-horizontal" role="form"  method="POST" name = "modifyform">
                ...
                <div class="form-group" style="text-align: center;" title="코드">
                ...
                <div class="form-group">
                    <label for="cFile" class="col-sm-4 control-label" title="차량사진">차량 사진 :</label>
                    <div class="col-sm-6">
                        <input type="text" id="cFile" name="cFile" class="form-control" value="${car.cFile}"onclick="test7()"readonly>
                         </div>
                </div>
                <button type="button"onclick="location.href='carAdSearchList.ca?page=${param.page}&&fieldName=${param.fieldName}&&word=${param.word}'"class="btn btn-default" title="돌아가기">돌아가기</button>           
                <button type="button"onclick="location.href='./carAdDetailPro.ca?cCode=${car.cCode}&&page=${param.page}&&fieldName=${param.fieldName}&&word=${param.word}'"class="btn btn-default" title="수정">수정</button>
