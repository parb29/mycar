...
h2{
  ...
  $( document ).ready( function() {
      $( 'a:contains('+ nowPage +')' ).css( {'color': '#f5f5f5', 'background-color': '#1e1a1b'} );
    } );
 </script>
...
<div class="container">
  <c:if test="${carList !=null && pageInfo.listCount >0}">
	    ...
	    <button class='btn btn-default pull-right'  id=insert onclick="location.href='carInsertForm.ca?page=${pageInfo.page}'"title= "제품등록">등&nbsp;록</button>
  	    <form action="carAdSearchList.ca?page=1" method="post" >
     ...
     <table class="table table-striped table table-hover">
      <tr>
	    ...
	    <c:forEach var="Code" items="${carList}">
            ...
            <td class="text-center col-xs-1 col-sm-1 col-md-1" onclick="location.href='carAdDetail.ca?cCode=${Code.cCode}&&page=${pageInfo.page}&&fieldName=${pageInfo.fieldName}&&word=${pageInfo.word}'"><img src="image/${Code.cFile}" width="70px" alt =" 상품정보" title="차량 사진" style="margin:0 auto;"> </td>
