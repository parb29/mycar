  ...
  <div class="row">
    ...
    <form class="form-horizontal" role="form" id="modifyForm" action="carModifyForm.ca?cFile=${car.cFile}"  method="POST" enctype="multipart/form-data"name = "Modifyform">
               <div class="form-group" style="text-align: center;">
                ...
                <div class="form-group" style="text-align: center;" title="장기/단기">
                 ...
                 <div class="form-group" style="text-align: center;" title="차량크기">
                 ...
                 <div class="form-group" style="text-align: center;" title="차종">
                 ...
                 <div class="form-group" style="text-align: center;" title="가격">
                ...
                <div class="form-group" style="text-align: center;" title="기어">
                ...
                <div class="form-group" style="text-align: center;" title="연료">
                ...
                <div class="form-group" style="text-align: center;" title="승차인원">
                ...
                <div class="form-group" style="text-align: center;" title="차량사진">
                ...
                <button type="button" onclick="location.href='carAdDetail.ca?cCode=${car.cCode}&&page=${param.page}&&fieldName=${param.fieldName}&&word=${param.word}'"class="btn btn-default" id="back" title="돌아가기">돌아가기</button>  
                <button type="button" class="btn btn-default "data-toggle="modal" id="modify" data-target="#${car.cCode}" title="수정하기">수정하기</button> 
                <button type="button"onclick="location.href='./carAdSearchList.ca?page=${param.page}&&fieldName=${param.fieldName}&&word=${param.word}'"class="btn btn-default" id="list" title="목록">목록</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer"> 
           <button type="button" class="btn btn-secondary" form = "modifyForm"  data-dismiss="modal" onclick="Modifyform.submit()"> &nbsp;네</button>
