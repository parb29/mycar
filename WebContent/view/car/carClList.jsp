  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
      ...
      <div class="panel-body">
       <a href= "carClSanList.ca?ctype=${param.ctype}&&csize=min&&page=1">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4"> 
      <div class="panel panel-primary">
        <div class="panel-body">
        <a href= "carClSanList.ca?ctype=${param.ctype}&&csize=sma&&page=1">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4"> 
      <div class="panel panel-primary">
        <div class="panel-body">
         <a href= "carClSanList.ca?ctype=${param.ctype}&&csize=mid&&page=1">
...
<div class="container" >    
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin-bottom:1%">
      <div class="panel panel-primary">
        <div class="panel-body">
         <a href= "carClSanList.ca?ctype=${param.ctype}&&csize=big&&page=1">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4"> 
      <div class="panel panel-primary">
        <div class="panel-body">
        <a href= "carClSanList.ca?ctype=${param.ctype}&&csize=suv&&page=1">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4"> 
      <div class="panel panel-primary">
        <div class="panel-body">
        <a href= "carClSanList.ca?ctype=${param.ctype}&&csize=van&&page=1">
