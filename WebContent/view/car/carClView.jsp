...
function logincheck() { 
	...
	if(id != "null"){
		 $('#rend').attr("required", "required");
	} else{
		$('#sbut').attr("data-toggle","modal");
		$('#sbut').attr("data-target","#loginmodal");
		return false;
	}
};
</script>
    ...
    <div class="col-sm-6">
      ...
      <form class="form-horizontal" role="form"  action="/mycar/resClWriteForm.re?ctype=${car.cType}&csize=${car.cSize}&cCode=${car.cCode}&page=<%=nowPage %>" method="POST" id="carClView">
                ...
                <div class="form-group" style="text-align: center;">
                    <label for="cCode"class="col-sm-4 control-label" title="상품 번호" >상품 번호 :</label>
                ...
                <div class="form-group">
                    <label for="cSize" class="col-sm-4 control-label" title="차량크기">차량 크기 :</label>
                    <div class="col-sm-6">
				...
				<div class="form-group" style="text-align: center; margin: auto;">
					...
					<div class="col-sm-6" style="text-align: center;">
						<input class="form-control" type="date" id="rend" name="rend">
					</div>
				</div><br/>                
              ...
              <button type="button"onclick="location.href='./carClSanList.ca?ctype=${param.ctype}&&csize=${param.csize}&&page=${param.page}'"class="btn btn-default" title="돌아가기"> 돌아가기</button>        
              <button id="sbut" type="submit" onclick="return logincheck();" class="btn btn-default" title="예약하기">예약하기</button>
            </div>  
            </form> <!-- /form -->
            </div>
