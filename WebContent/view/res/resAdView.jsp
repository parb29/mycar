  ...
  <div class="row">
    ...
    <div class="well"  style="background-color: #FFFFFF;">
     <form class="form-horizontal" role="form"  method="POST" name = "modifyform" action="resAdViewAction.re">
               ...
               <button type="button" onclick="location.href='resAdSearchAction.re?rnum=${resAdView.rnum}&page=${nowPage}'"class="btn btn-default" title="리스트로 돌아가기">목록으로</button>           
              <button type="button" onclick="location.href='resAdViewProAction.re?rnum=${resAdView.rnum}&page=${nowPage}'"class="btn btn-default" title="수정">수정</button>
				<button type="button" class="btn btn-default" data-toggle="modal" data-target="#${resAdView.rnum}" title="예약 취소">예약 취소</button>
				<div class="modal fade" id="${resAdView.rnum}" role="dialog">
		           ...
		           <div class="modal-body">
		               ...
		               <div class="modal-footer">
		                <button type="button" onclick="location.href='resAdDeleteAction.re?rnum=${resAdView.rnum}&page=1&id=${pageInfo.viewId}&fieldName=${pageInfo.fieldName}'" class="btn btn-secondary btn" title="예약취소">예</button>
