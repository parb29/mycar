...
<jsp:include page="view/main/mycarClHeader.jsp"></jsp:include>
    ...
    <div class="slider">
        <div class="owl-carousel owl-theme">
            <div class="item"><a href="http://localhost:8080/mycar/carClSanList.ca?ctype=long&&csize=suv&&page=1"><img src="image/indexImage2.jpg" class="img-responsive" alt=""></a>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="slider-captions">
                                ...
                                <a href="http://localhost:8080/mycar/carClSanList.ca?ctype=long&&csize=suv&&page=1" id="detailButton" class="btn btn-default btn-lg">상세보기</a> </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="item"><a href="http://localhost:8080/mycar/carClSanList.ca?ctype=short&&csize=big&&page=1"><img src="image/indexImage1.jpg?31332" class="img-responsive" id="indexImage1" alt=""></a>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12  col-xs-12">
                            <div class="slider-captions">
                                ...
                                <a href="http://localhost:8080/mycar/carClSanList.ca?ctype=short&&csize=big&&page=1" id="detailButton" class="btn btn-default btn-lg">상세보기</a> </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="item"><a href="http://localhost:8080/mycar/carClSanList.ca?ctype=long&&csize=mid&&page=1"><img src="image/indexImage3.jpg?afer222333" class="img-responsive" alt=""></a>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12  col-xs-12">
                            <div class="slider-captions">
                                ...
                                <a href="http://localhost:8080/mycar/carClSanList.ca?ctype=long&&csize=mid&&page=1" id="detailButton" class="btn btn-default btn-lg" id="detailButton" class="btn btn-default btn-lg">상세보기</a> </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="service-block">
                        ...
                        <div class="service-content">
                            <h3><a href="noticeList.no" class="title" title="공지사항 게시판 바로가기">공지사항</a></h3><br>
                ...
                <!-- service-start-->
 				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="service-block">
                        ...
                        <div class="service-content">
                             <h3><a href="qnaQClList.qn" class="title" title="QnA 게시판 바로가기">QnA</a></h3><br>
